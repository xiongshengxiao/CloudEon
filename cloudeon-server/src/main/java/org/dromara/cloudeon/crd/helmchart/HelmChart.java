...
public class HelmChart extends io.fabric8.kubernetes.client.CustomResource<HelmChartSpec, HelmChartStatus> implements io.fabric8.kubernetes.api.model.Namespaced {
}
