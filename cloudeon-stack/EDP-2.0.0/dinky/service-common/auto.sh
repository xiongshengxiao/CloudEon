...
# JMX path
JMX="-javaagent:$APP_HOME/lib/jmx_prometheus_javaagent-0.20.0.jar=$JMX_PORT:$APP_HOME/config/jmx/jmx_exporter_config.yaml"
#JVM OPTS
export JVM_MEM=$[ $MEM_LIMIT / 1024 / 1024  * $JVM_MEM_PERCENTAGE / 100 ]M
export PERM_SIZE_MEM=$[ $MEM_LIMIT / 1024 / 1024  * $PERM_SIZE_PERCENTAGE / 100 ]M

JVM_OPTS="-Xms$JVM_MEM -Xmx$JVM_MEM -XX:PermSize=$PERM_SIZE_MEM -XX:MaxPermSize=$PERM_SIZE_MEM"
